...
let ownername = 'IdamxixiⓋ' //NAMA OWNER
let owner = '6285691890852' // NOMOR OWNER
let bold = '*' 
let petik = '```'
let faketeks = `_Neo Bot By IdamxixiⓋ` 
...
zeroyt7.sendMessage(from, { contentText: `${ok}`, footerText: `_Neo Bot By IdamxixiⓋ_`, buttons : [{ buttonId: `.botstat`, buttonText: { displayText: 'BOT STATISTIC' }, type: 1 },{ buttonId: `.sewabot`, buttonText: { displayText: 'SEWA BOT' }, type: 1 }], 
...
costum(buffer, sticker, Verived, `Jangan Lupa SUBSCRIBE YT : IdamxixiⓋ`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa SUBSCRIBE YT : IdamxixiⓋ`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
ok = `Neo Bot By IdamxixiⓋ`
sendButLoc(from, lolot, ok, img, but)
break
case 'muridbot':
katalog(`Open Murid Bot By IdamxixiⓋ
...
case 'botgroup':
reply(`Grup 1 :
https://chat.whatsapp.com/IHOS7I4XsYl0PwRE7XvEsE
Grup 2 :
https://chat.whatsapp.com/IHOS7I4XsYl0PwRE7XvEsE`)
break
case "runtime":
